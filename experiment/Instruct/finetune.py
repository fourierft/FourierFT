...
from transformers import LlamaForCausalLM, LlamaTokenizer, BitsAndBytesConfig, HfArgumentParser, TrainingArguments
...
os.environ["WANDB_PROJECT"] = "Safety-CL" 
...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(default="Llama-2-7b-chat-hf", metadata={"help": "the model name"})
...
print(script_args.target_modules)
...
tokenizer = LlamaTokenizer.from_pretrained(script_args.model_name, use_fast=True)
...
# trainer.save_model(script_args.model_name + "-broken-0103")