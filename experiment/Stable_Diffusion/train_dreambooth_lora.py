...
def main(args):
    ...
    # count parameters with gradient
    total_params = sum(p.numel() for p in unet.parameters())
    total_trainable_params = sum(p.numel() for p in unet.parameters() if p.requires_grad)
    print(f"trainable parameters: {total_trainable_params} || all parameters: {total_params} ||  trainable%: {total_trainable_params / total_params:.3f}")
