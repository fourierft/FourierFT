...
def main(
    ...
    if mode == "fourier":
        save_id = f'{model_name}-{mode}-f{n_frequency}-{dataset_name}'
    elif mode == "lora":
    ...
    os.makedirs(os.path.join(results_dir, save_id), exist_ok=False)
    import optuna
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-frequency", type=int, default=10000)
    ...
    parser.add_argument("--n-trial", type=int, default=20)
